...
describe('Database', () => {
    ...
    describe('.isAdapterFor', () => {
        it('returns true when user gives entire db object generated by cli', () => {
            (0, chai_1.expect)(database_1.default.isAdapterFor(index_js_1.default)).to.equal(true);
        });
        it('returns true when user gives sequelize', function () {
            (0, chai_1.expect)(database_1.default.isAdapterFor(this.sequelize)).to.equal(true);
        });
    });
    describe('#resources', () => {
        it('fetches all resources when entire db is given', () => {
            const database = new database_1.default(index_js_1.default);
            (0, chai_1.expect)(database.resources()).to.have.lengthOf(Object.keys(index_js_1.default.sequelize.models).length);
            (0, chai_1.expect)(database.resources()[0]).to.be.an.instanceof(resource_1.default);
        });
        it('fetches all resources when user gives sequelize', function () {
            const database = new database_1.default(this.sequelize);
            (0, chai_1.expect)(database.resources()).to.have.lengthOf(1);
            (0, chai_1.expect)(database.resources()[0]).to.be.an.instanceof(resource_1.default);
        });
    });
});
